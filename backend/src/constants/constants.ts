export const BACKGROUND_FOLDER_PATH = './public/backgrounds/';
...
export const THUMBNAIL_FOLDER_PATH = './public/thumbnail/';
export const THUMBNAIL_FOLDER_PATH_MOBILE = './public/thumbnail/mobile/';
